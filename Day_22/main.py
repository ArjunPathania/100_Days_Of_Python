...
def game_loop(screen, l_paddle, r_paddle, ball, l_scoreboard, r_scoreboard):
    ...
    while is_game_on:
        ...
        play_again = check_score(l_scoreboard, r_scoreboard, screen)
        if play_again == 'n':
            is_game_on = False
        elif play_again == 'y':
